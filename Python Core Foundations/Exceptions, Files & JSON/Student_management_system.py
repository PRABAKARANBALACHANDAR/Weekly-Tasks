...
class StudentManagementSystem :
    ...
    def _principal_student_menu (self ):
        while True :
            ...
            elif action =='6':self ._principal .change_assigned_teacher ()
            elif action =='7':break 
    ...
    def _teacher_apply_leave (self ):
        ...
        try :
            ...
            reason =input ("Reason: ")
            lid =self ._leave_manager .apply_leave (
            self ._teacher .current_teacher_name ,
            date ,
            days ,
            reason ,
            role ="Teacher"
    ...
    def _teacher_menu (self ):
        while True :
             ...
             elif action =='5':self ._teacher .view_own_attendance ()
             elif action =='6':
                 self ._announcement_manager .view_all_announcements ()

                 announcement_ids =self ._announcement_manager .get_announcement_ids ()
                 self ._notification_manager .mark_announcements_viewed (self ._teacher .current_teacher_name ,announcement_ids )
             elif action =='7':self ._teacher_query_menu ()
             elif action =='8':self ._teacher_leave_check ()
             elif action =='9':self ._teacher_apply_leave ()
             elif action =='10':self ._teacher_check_leave_status ()
             elif action =='11':break 
             else :print ("Invalid.")
