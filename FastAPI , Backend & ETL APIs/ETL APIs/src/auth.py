...
def login(body: LoginRequest):
    if (body.username != API_ADMIN_USERNAME and body.password != API_ADMIN_PASSWORD) and (body.username != DOCTOR_NAME and body.password != DOCTOR_PASSWORD) and (body.username != PATIENT_NAME and body.password != PATIENT_PASSWORD):
    ...
    if body.username == DOCTOR_NAME and body.password == DOCTOR_PASSWORD:
